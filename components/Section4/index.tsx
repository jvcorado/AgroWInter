...
export const Section4 = () => {
  return (
    <div className="bg-gradient-card-2">
      ...
      <div className=" flex flex-col items-center justify-center lg:gap-16">
        <h2 className="text-900 text-5xl lg:text-6xl font-bold text-center text-card-2">
        ...
        <div className="w-full p-10 lg:px-40 grid md:grid-cols-2 lg:grid-cols-3 gap-10 text-center">
          <div className="bg-gradient text-white grid-cols-12 p-10 rounded-xl shadow-2xl  hover:scale-110 transition-transform">
            <span className="p-3 shadow-xl mb-3 inline-block rounded-lg bg-white">
              <i
                className="pi pi-money-bill icon"
                style={{ fontSize: "40px" }}
              ></i>
            </span>
            <div className="flex flex-col">
              <span className="text-900 text-xl mb-3 font-medium ">
                Fast & Global Support
              </span>
              <span className="text-700 leading-3">
        ...
        <div className="px-10 lg:p-0 m-auto w-full lg:w-4/12  flex items-center justify-center">
          <Button bg="bg-gradient-card-blue"></Button>
        </div>
        <div className="w-full lg:h-80 mt-10 lg:mt-0">
